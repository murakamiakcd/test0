...
$fp = fopen($filename,'a');
//テキストファイルの読み込み
$data = file_get_contents( 'kadai2-6.txt' );
//配列の分割
$data = explode("\n", $data);
//配列の数
$cnt = count( $data );
...
<form method="post" action="mission_2-6.php" style="position: absolute; right: 0px; top: 50px" align="right" >
...
<form method="post" action="mission_2-6.php" onSubmit="return checkSubmit()" style="position: absolute; right: 0px; top: 250px" align="right" >
...
<form method="post" action="mission_2-6.php"style="position: absolute; right: 0px; top: 350px"align="right">
