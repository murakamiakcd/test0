...
//データベース読み込み
$sql = 'SELECT * FROM tbtalk3 ORDER BY number';
...
$sql = $pdo -> prepare("INSERT INTO tbtalk3 (number,name, comment,time,passward ) VALUES (:number,:name, :comment, :time, :passward )"); 
...
//$sql = "update tbtalk3 set name='$name' , comment='$comment' ,time='$time' ,passward='$passward' where number = $chnumhid";
//$result = $pdo->query($sql);


$sql = $pdo -> prepare("update tbtalk3 set name=:name , comment=:comment ,time=:time ,passward=:passward where number = :number"); 
...
//$sql = "update tbtalk3 set  name='' , comment=''  where number = $delnum"; 
//$result = $pdo->query($sql);


$sql = $pdo -> prepare("update tbtalk3 set  name='' , comment=''  where number = :number"); 
...
<!--入力フォームの情報をmission2-15.phpに送信-->
<form method="post" action="mission_2-15.php" style="position: fixed; right: 0px; top: 10px" align="right" name="writeform">
名前<input type="text" name="name" value="<?=$chname.$keepname?>"><br/>
<a >コメント</a></br>
...
<form method="post" action="mission_2-15.php" onSubmit="return checkSubmit()" style="position:  fixed; right: 0px; top: 250px" align="right" >
...
<form method="post" action="mission_2-15.php"style="position:  fixed; right: 0px; top: 350px"align="right">
...
<form method="post" action="mission_2-15.php"style="position:  fixed; right: 0px; top: 430px"align="right">
